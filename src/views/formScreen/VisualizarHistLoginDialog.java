 ...
 * @author adimael
 */
public class VisualizarHistLoginDialog extends javax.swing.JDialog {

    /**
     * Creates new form VisualizarUserDialog
     */
    public VisualizarHistLoginDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableUsers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Data de entrada", "Data de saída"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarHistLoginDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisualizarHistLoginDialog dialog = new VisualizarHistLoginDialog(new javax.swing.JFrame(), true);
